...
import { createMedicalHistory, deleteMedicalHistory, exportReportToExcel, getMedicalHistories, getMedicalHistoriesByPatient, getMedicalHistoriesWithPatientCIAndSpecialty, getMedicalHistory, updateMedicalHistory } from "../controllers/medicalHistory.controllers.js";
...
router.get('/medical_histories/export', [verifyToken], exportReportToExcel)
